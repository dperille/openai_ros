...
if __name__ == '__main__':
    ...
    rospy.init_node('jackal_maze_qlearn',
    ...
    env = StartOpenAI_ROS_Environment('JackalMaze-v0')
    rospy.loginfo("Gym environment done==>" + str(env))

    # Set the logging system
    rospack = rospkg.RosPack()
    pkg_path = rospack.get_path('openai_ros')
